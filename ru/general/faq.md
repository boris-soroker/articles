...
Тем не менее, существует несколько обходных возможностей «спрятать» нежелательное сообщение:
 ...
 - Админы команды пользователя-отправителя могут спрятать нежелательное сообщение от не-админов (заметим, что соответствующая иконка в интерфейсе админов обманчиво называется "Delete"). Понятно, что если отправитель не является админом в данной команде, то ему следует попросить кого-то из админов спрятать нежелательное сообщение от остальных не-админов.
