...
[1] - **открытая комната** типа 1:1 ("один на один") между пользователем с экранным именем _Шарик_ и участником под экранным именем _Фёдор_. Заметим, что открытую комнату можно закрыть, её имя можно найти в ростере, кликнуть на это имя, и данная комната будет открыта заново.  
