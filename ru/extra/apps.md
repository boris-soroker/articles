...
Ссылка на файл .pkg – [здесь](http://labs.kato.im/Kato.pkg).

Данное приложение разработано с использованием технологии [MacGap](https://github.com/MacGapProject/MacGap1). В нём известны следующие существенные проблемы:

- Звуковые оповещения не всегда работают корректно.
- Отсутствует поддержка WebRTC, что не позволяет делать аудио-конференции и видео-конференции, а также демонстрацию экрана.
- Не поддерживается функциональность "copy-paste" для изображений, драматически упрощающая работу пользователей Kato в браузерах Chrome и Firefox.
...
Ниже приведена последовательность действий для создания ярлыка приложения (Chrome shortcut):

(1) Зайти в браузере Chrome на [https://app.kato.im](https://app.kato.im).
