...
Клик мышкой на строку в ростере пользователя с именем участника либо открывает комнату 1:1 с этим участником (если данная комната 1:1 не открыта), либо выбирает поле ввода это комнаты 1:1 (если данная комната 1:1 открыта).
