...
Самый прямой и короткий ответ на этот вопрос: «Пока никак». Жалоб на слишком яркий белый фон мы слышим очень много, и мы займёмся решением этой задачи сразу после того, как основная функциональность будет достаточно отшлифована.

Некоторые наши пользователи самостоятельно пишут custom CSS (что требует определённых знаний и навыков).
...
(2) Сосчитать число горизонтальных полос на иконке «гамбургер» в ростере. Если их три, то клавиатурный контроль выключен:

![clip.png](https://in.kato.im/97cd314066d6b31addb731726aeccccab667babea7aceb734616ab824f95fd23/clip.png)

Если их четыре, то клавиатурный контроль включен:
