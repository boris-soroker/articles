...
- Чёрный – средний уровень важности. Среди непрочитанных сообщений имеется сообщение в любой комнате, для которой данным пользователем установлен уровень шума "Follow".
- Серый – низший уровень важности. Среди непрочитанных сообщений имеется сообщение в любой комнате, для которой данным пользователем установлен уровень шума "Watch").
