...
### <a href="#conferences" name="conferences">Как послать в сообщении линки к видео-конференциям и аудио-конференциям?</a>
...
Для того, чтобы избежать такого неудобства, сообщения длиной более 2000 символов помещаются в отдельные документы, при этом сообщение сокращается до ссылки на документ (и, иногда, начало сообщения), которое и публикуется в комнате. Эти отдельные документы могут быть открыты в отдельной вкладке браузера, для чего следует просто кликнуть на ссылку в истории. 
...
По клику на ссылке в отдельном окне браузера откроется всё сообщение целиком:
...
Клик на линк открывает полный текст сообщения:
...
Клик на нее открывает полный текст сообщения:
