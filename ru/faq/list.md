...
- Красный – высший уровень важности. Среди непрочитанных сообщений имеется:
  - любое сообщение в комнате типа 1:1.
  - сообщение в любой комнате, содержащее прямой оклик данного пользователя.
  - сообщение в любой комнате, содержащее оклик комнаты, для которой данным пользователем установлен уровень шума "Follow".
- Чёрный – средний уровень важности. Среди непрочитанных сообщений нет сообщений «красного» уровня, но имеется сообщение в любой комнате, для которой данным пользователем установлен уровень шума "Follow".
- Серый – низший уровень важности. Среди непрочитанных сообщений нет сообщений «чёрного» уровня, но имеется сообщение в любой комнате, для которой данным пользователем установлен уровень шума "Watch").
