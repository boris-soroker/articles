...
## <a href="#audit-log" name="audit-log">Внутренняя интеграция с журналом аудита.</a>
...
<br />
У каждой комнаты в Kato есть собственный уникальный email-адрес. Поскольку никоторые внешние инструменты поддерживают только email-оповещения, данную интеграцию можно использовать для перенаправления подобных сообщений в комнаты мессенджера. 
...
<br />
[Airbrake](https://airbrake.io/)— это сервис для отслеживания ошибок в веб-приложения. Интеграция с Kato может быть использована для генерации автоматических оповещений в комнаты мессенджера при возникновении ошибки. 
...
<br />
[Asana](https://asana.com/) — удобный инструмент для управления проектами и задачами. С помощью соответствующей интеграции пользователи могут отправлять оповещения из Asana в Kato (интеграция работает через сервис Zapier).
...
<br />
[Balanced](https://www.balancedpayments.com/) — платёжный сервис, сообщения о событиях в котором можно выводить в Kato. 
